...
namespace chatDAL
{
    ...
    /// 数据库访问基类
    /// </summary>
    public class PostgreDbAccess : IDataAccessAdapter
    {
        /// <summary>
        /// 数据库连接检查，用于访问数据库是否正常访问。
        /// </summary>
        public void _ConnCheck(string connectionString)
        {
        ...
        public int ExecuteNonQueryByTran(string connectionString, CommandType cmdType, string cmdText,
            bool tag,DbParameter[] cmdParms)
        {
